...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        MenuDAO registDAO = new MenuDAO();       // DAO에서 연결해야하니깐~!
        ...
        // ▲ 맵안에서 정수,문자열로 관리하겠다는 의미! (행 여러개일때)
        ...
        int categoryCode = 0;    // 카테고리코드 0으로 초기화해놓는다.
        switch (categoryName) {
            case "식사":
                categoryCode = 1;
                break;
...
// switch 문에서 정한 케이스까지만 코드번호 입력가능!! (아니면, 오류발생!)
// 출력값은 정상작동되는데 입력하면 오류발생중이다.....ㅠㅠ